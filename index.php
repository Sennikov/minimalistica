...
<body>
	...
	<?php 
	$title="Мой шаблон";
	$h1="Шаблон из домашнего задания";
	$year=date('Y');
	?>
	...
	<div id="content">
		...
		<div id="footer">
		      <p>Copyright <?=$year?> &copy; <em><?= $title ?></em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>